...
import { Ivy } from '@/components/custom/decoration/Ivy'
...
export default function Home() {
  ...
  return (
    <main className='flex w-full flex-col items-center'>
      <div className='absolute flex h-full gap-4 md:left-1/4'>
        {Array.from({ length: 7 }, (_, index) => (
          <div key={index} className='relative flex w-4 overflow-visible'>
            ...
            {Array.from({ length: 7 }, (_, index) => Ivy(index))}
          </div>
        ))}
      </div>
      <section className='from-primary/20 z-20 flex w-full flex-col items-center justify-center gap-40 bg-gradient-to-b md:h-screen'>
        <div className='mt-20 flex flex-col items-center gap-20  md:flex-row'>
          ...
          <Card className='shadow-primary/60 hover:shadow-primary/80 relative size-80 select-none overflow-hidden rounded-full shadow-lg transition-all duration-500 ease-in-out'>
            <div
              id='portrait-gradient'
              className='from-primary/40 absolute size-full bg-gradient-to-t'
            />
            <div
              id='hero-portrait'
              className='size-full'
        ...
        <Card className='flex size-fit flex-col p-10'>
          <CardHeader className='relative flex w-full flex-row items-center'>
            <h1 className='decoration-primary mx-auto self-center text-2xl font-semibold uppercase underline underline-offset-2'>
              About me
            </h1>
      ...
      <section className='from-primary/40 relative flex h-screen w-full flex-col items-center justify-center overflow-hidden bg-gradient-to-t'>
        {/* <div
          id='project'
          className='h-full w-screen opacity-80 blur-lg'
          style={{
            backgroundImage: `url(/images/plants/distle_bg.jpg)`,
            backgroundSize: 'cover',
            backgroundPosition: 'center',
            backgroundBlendMode: 'multiply'
          }}
        /> */}
        <div className='flex size-full flex-col items-center gap-20 py-10'>
          ...
          <div className='flex flex-col items-center justify-center gap-4 overflow-x-auto px-4 md:flex-row'>
            <Card className='bg-card jusitfy-around flex w-80 flex-col p-2 '>
              <Link
                href='/rickandmorty'
              ...
              >
                ...
                <h2 className='text-xl font-semibold'>Rickdex</h2>
                <div className='flex flex-col'>
                  <p className='text-justify'>
                    Introducing the ultimate Rick and Morty companion tool: the
                    &quot;Rickdex&quot;. Imagine a sleek, user-friendly
                    interface similar to a Pokédex, but designed specifically
                    for fans of the intergalactic adventures of Rick Sanchez and
                    his hapless grandson, Morty. The Rickdex makes exploring the
                    show&apos;s vast multiverse a breeze.
                  </p>
                  <Link
                    href='https://rickandmortyapi.com'
                    className='decoration-primary italic underline underline-offset-2'
                  >
